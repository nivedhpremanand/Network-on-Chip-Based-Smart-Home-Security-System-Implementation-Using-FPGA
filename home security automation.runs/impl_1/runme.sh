...
HD_PWD='D:/VIVADO/home security automation/home security automation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log home_security_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source home_security_system.tcl -notrace
