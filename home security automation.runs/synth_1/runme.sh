...
HD_PWD='D:/VIVADO/home security automation/home security automation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log home_security_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source home_security_system.tcl
