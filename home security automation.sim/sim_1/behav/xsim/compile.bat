...
REM
REM Generated by Vivado on Tue Oct 14 23:35:49 +0530 2025
...
echo "xvlog --incr --relax -prj home_security_system_vlog.prj"
call xvlog  --incr --relax -prj home_security_system_vlog.prj -log xvlog.log
